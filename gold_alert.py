...
RECEIVERS = {
    ...
    "your_second_email@gmail.com": "Mandarin" # REPLACE with your second email address
}
...
# 3. Calculate Gold in AUD per Gram
...
# Connect to the server once, then loop through our receivers
with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
    ...
    for receiver_email, language in RECEIVERS.items():
        ...
        if language == "English":
            if gold_aud_gram <= TARGET_PRICE_AUD:
                ...
                msg.set_content(
                    ...
                    f"Current Price: ${gold_aud_gram:.2f} AUD/gram\n"
                    f"Target Price: ${TARGET_PRICE_AUD:.2f} AUD/gram\n\n"
                    f"The price has not reached your target yet."
                )
        ...
        # Send the customized message for this specific person
        smtp.send_message(msg)

print(f"Updates sent successfully! Current price: ${gold_aud_gram:.2f} AUD")
